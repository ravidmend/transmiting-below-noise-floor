...
class hackathon_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.tr_gain = tr_gain = 15
        self.rc_gain = rc_gain = 10
        ...
        self.uhd_usrp_source_0.set_gain(rc_gain, 0)
        ...
        self.uhd_usrp_sink_0.set_gain(tr_gain, 0)
        ...
        self.hackathon_encoder_0 = hackathon.encoder(1, 1, 1, 1, 1)
        self.hackathon_decoder_0 = hackathon.decoder(1, 1, 1, 1, 1)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.hackathon_encoder_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.hackathon_encoder_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.uhd_usrp_source_0, 0), (self.hackathon_decoder_0, 0))
    ...
    def set_tr_gain(self, tr_gain):
        ...
        self.uhd_usrp_sink_0.set_gain(self.tr_gain, 0)
    ...
    def set_rc_gain(self, rc_gain):
        ...
        self.uhd_usrp_source_0.set_gain(self.rc_gain, 0)
